...
function signup(event) {
    ...
    if (validation != 5) {
        ...
        if (phone == "") { document.getElementById('empty_phone').style.visibility = "visible" }
        else {
            document.getElementById('empty_phone').style.visibility = "hidden"
            validation++;
        }
    ...
    if (validation == 7) {
        ...
        axios.post('http://13.232.149.196:3000/chat/adduser', user)
        .then(res => {
