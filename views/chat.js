...
window.addEventListener('DOMContentLoaded',async ()=>{
    ...
    const grp = await axios.get(`http://13.232.149.196:3000/getgroups`,{headers:{"Authorization":token}});
...
async function addMessage(e){
    ...
    try{
        ...
        if(currGroup==null){
            ...
            await axios.post(`http://13.232.149.196:3000/addmessage`, obj,{headers:{"Authorization":token}});
        }
...
async function createGroup(){
    ...
    await axios.post('http://13.232.149.196:3000/creategroup',{groupName:name.value,admin:true},{headers:{"Authorization":token}})
    .then(res=>{
...
async function add(grpId){
    let res =  await axios.post('http://13.232.149.196:3000/getallmembers',{groupId:grpId},{headers:{"Authorization":token}});
...
async function makeAdmin(grpId,userId){
    ...
    const res = await axios.post(`http://13.232.149.196:3000/makeadmin`,obj,{headers:{"Authorization":token}});
    location.reload();
}
...
async function deleteUser(grpId,userId){
    ...
    const res = await axios.post(`http://13.232.149.196:3000/deleteuser`,obj,{headers:{"Authorization":token}});
    location.reload();
}
...
async function addUserInGroup(grpId){
    try{
        ...
        const res = await axios.post(`http://13.232.149.196:3000/adduseringroup`,obj,{headers:{"Authorization":token}});
...
async function showMessages(groupId){
  ...
  setInterval(async function(){ 
        ...
        const res = await axios.post(`http://13.232.149.196:3000/getmessage`,obj,{headers:{"Authorization":token}});
